        ...
        <div class="card-body">
            @if(!empty($data['item']) and !empty($data['item']->name) )
                <div class="jumbotron row">
                    ...
                    @auth
                        <div class="col-sm-2">
                            <a class="btn btn-lg btn-success" href="{{ route( 'admin.autor.edit', ['id' => $data['item']->id] ) }}">update</a>
                            <a class="btn btn-lg btn-danger" href="javascript:void(0)" onclick="confirmdrop('{{ route('admin.autor.destroy', ['id' => $data['item']->id]) }}')">delete</a>
                        </div>
                        <script>
            ...
            <div class="row">
                ...
                @else
                    <h4>
                        В данный момент нет книг этого автора.
                    </h4>
                @endif
            </div>
        </div>
